                ...
                li.addEventListener('click', (e) => {
                    ...
                    route.on('routesfound', function (event) {
                        ...
                        popup = L.popup().setLatLng(position)
                            .setContent(clickedData.name + '<br><a class="w-100 justify-content-end" href="index.php?locateden=' + clickedData.name + '&latden=' + clickedData.lat + '&lngden=' + clickedData.lon + '&kcach=' + distance + '"><button class="btn btn-primary mt-1">Xác nhận</button></a>')
                            .openOn(map)
                    });
