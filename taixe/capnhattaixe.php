        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
                  ...
                  <form method="POST" action="themtaixe.php">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="TX_HINHANH" name="TX_HINHANH" required>
                      </div>
                    </div>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <form method="POST" action="updatetaixe.php">
                    <div class="card-header">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                <form method="POST" action="themxechotaixe.php">
                    <div class="card-header">
                      <h4>Thêm xe cho tài xế</h4>
                    </div>
                    <div class="card-body">
                      <div class="form-group">
                        <label>Mã tài xế</label>
                        <input type="number" class="form-control" id="TX_MA" name="TX_MA" required="">
                      </div>
                      <div class="form-group">
                        <label>Mã xe</label>
                        <input type="number" class="form-control" id="X_MA" name="X_MA" required="">
                      </div>
                      <div class="form-group">
                ...
                <div class="card">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT xe.* FROM xe 
                                LEFT JOIN phutrach ON phutrach.X_MA = xe.X_MA 
                                WHERE phutrach.X_MA IS NULL";
                        $result = $conn->query($sql);
                        if ($result ->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                              echo "<tr>";
                              echo "<td>". $row['X_MA'] . "</td>";
                              echo "<td>". $row['LX_MA'] . "</td>";
                              echo "<td>". $row['X_BIENSO'] . "</td>";
                              echo "<td>". $row['X_MOTA'] . "</td>";
                              echo "<td>". $row['X_HINHANH'] . "</td>";
                              echo "</tr>";  
                          }
                        }else{
