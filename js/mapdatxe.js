...
(function(){
    ...
    // var marker = L.marker([latitude, longitude]).addTo(mapdx); //đặt vị trí hiện tại của khách hàng

    var popup = L.popup()

    L.circle([latitude, longitude], {radius: 6000}).addTo(mapdx);
